...
namespace AI
{
    ...
    //人工智能12-27
    {
        ...
        /// <summary>
        /// 不使用自定义的迭代子检索指定的文本文件中，包含指定字符串的个数的方法111111
        /// </summary>
        ...
        public static void TestReadingFile(string keyString)
        {
            ...
            try
            {
                sr = File.OpenText("C:/Users/lza/Desktop/tempFile.txt");
            }
        ...
        public static void TestStreamReaderEnumerable(string keyString)
        {
            ...
            {
                stringsFound =
                      from line in new StreamReaderEnumerable(@"C:\Users\lza\Desktop\tempFile.txt")
                      where line.Contains(keyString)
                      select line;
                Console.WriteLine("数量：" + stringsFound.Count());
            }
